...
function createCanvas(container, w, h) {
    ...
    canvas.width = w || __aicp_width__;
    canvas.height = h || __aicp_height__;
...
function MousePosition(canvas) {
    ...
    var result = {
        get x() { return pos.x; },
        get y() { return pos.y; },
        get clicked() { return pos.clicked; },
        get pressed() { return pos.pressed; },
        set clicked(v) { pos.clicked = v; },
        get: function() { return { x: pos.x, y: pos.y, clicked: pos.clicked, pressed: pos.pressed }; },
        consumeClick: function() { var v = pos.clicked; pos.clicked = false; return v; }
    };
    
    Object.defineProperty(result, 'x', { get: function() { return pos.x; } });
    Object.defineProperty(result, 'y', { get: function() { return pos.y; } });
    Object.defineProperty(result, 'clicked', { get: function() { return pos.clicked; }, set: function(v) { pos.clicked = v; } });
    Object.defineProperty(result, 'pressed', { get: function() { return pos.pressed; } });
